...
public class worKer {
	...
	public void Info() {
		sc.nextLine();
		System.out.println("input name of worker:");
		setName(sc.nextLine());
		
		System.out.println("input age of worker:");
		setAge(sc.nextInt());
		
		sc.nextLine();
		System.out.println("input gender of worker:");
		setGenDer(sc.nextLine());
		
		System.out.println("input address of worker:");
		setAddress(sc.nextLine());
		
		System.out.println("input hoursWorked of worker:");
		setHoursWorked(sc.nextInt());
		
		System.out.println("input hoursRate for worker:");
